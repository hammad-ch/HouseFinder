...
<head>
	...
	<!-- set the page title -->
	<title>Add Watchman Service</title>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Askari guards" id="itemN-15">
                              </div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<div class="form-group">
								  <label for="itemN-32">Guard Name</label>
								  <input type="text" class="form-control" placeholder="Asad" id="itemN-32">
								</div>
							  </div>
                            <div class="col-xs-12 col-sm-6">
                              <div class="form-group">
                                <label for="itemN-16">Phone Number</label>
                                <input type="number" class="form-control" placeholder="15000" min="0" max="30000" id="itemN-16">
                              </div>
                            </div>
