...
<head>
	...
	<!-- set the page title -->
	<title>Add Sweeper Service</title>
                      ...
                      <div class="formContent">
                        <form>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12">
                              <div class="form-group">
                                <label for="itemN-15">Name*</label>
                                <input type="text" class="form-control" placeholder="Name" id="itemN-15">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                              <div class="form-group">
                                <label for="itemN-16">Phone Number</label>
                                <input type="number" class="form-control" placeholder="03000000000" id="itemN-16">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                  <label for="itemN-18">Address</label>
                                  <input type="text" class="form-control" placeholder="Rawalpindi cantt" id="itemN-18">
                                </div>
							  </div>
							  <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                  <label for="itemN-19">Service From</label>
							  ...
							  <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                  <label for="itemN-20">Service To</label>
                                  <input type="text" class="form-control" placeholder="Rawalpindi cantt" id="itemN-20">
                                </div>
                              </div>

                            <div class="col-xs-12">
                              <div class="form-group">
                              <label for="itemN-22">Description</label>
                                <textarea class="form-control" id="itemN-22" placeholder="Service Description.."></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="btnArea">
