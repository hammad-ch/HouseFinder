										...
										<ul class="list-unstyled headerContactList">
											<li>
												...
												<div class="descr hidden-xs">
													<strong class="fwNormal elemenBlock text"><a href="#">+90 3065085832</a></strong>
									...
									<div class="post-detail">
										...
										<article class="accountData newsPostColumn newsPostColumn2 bgWhite bdr-none mb-30">
											<div class="aligncenter">
												<img src="https://via.placeholder.com/750x400" alt="image description">
											</div>
											...
											<blockquote>
												<q>Ut euismod ultricies sollicitudin. Curabitur sed dapibus nulla. Nulla eget iaculis lectus. sit amet rutrum elementum, est elit tristique turpis, et iaculis mi tortor finibus turpis.</q>
											</blockquote>
												...
												<div>
													<div class="col-xs-12">
														...
														<article class="newsPostColumn">
															...
															<p>
																Integer mattis magna volutpat euismod habitant mi faucibus elementum proin mi, lobortis iaculis dolor torquent...
															</p>
												...
												<div>
													<div class="col-xs-12">
														...
														<article class="newsPostColumn">
															...
															<h2 class="fontNeuron"><a href="#">Getting Started Designing Apps for the Apple Watch</a></h2>
															<p>
																<a href="#" class="btn btnSmall btn-info">Ali Tufan</a>
																<time datetime="2011-01-12">February 9, 2017</time>
																<a href="#" class="commentsCount">12 comment</a>
			                                	...
			                                	<div class="hb-ratingandskillbar">
				                                	...
				                                	<div id="hb-ourskill" class="hb-ourskill hb-skillgroup">
														<div class="hb-skill">
															...
															<div class="hb-skillbar" style="width: 95%;"></div>
															</div>
														</div>
														<div class="hb-skill">
															<div class="hb-skillholder" data-percent="80%">
																<div class="hb-skillbar" style="width: 80%;"></div>
															</div>
														</div>
														<div class="hb-skill">
															<div class="hb-skillholder" data-percent="50%">
																<div class="hb-skillbar" style="width: 50%;"></div>
															</div>
														</div>
														<div class="hb-skill">
															<div class="hb-skillholder" data-percent="90%">
																<div class="hb-skillbar" style="width: 90%;"></div>
															</div>
														</div>
														<div class="hb-skill">
															<div class="hb-skillholder" data-percent="0%">
																<div class="hb-skillbar" style="width: 0%;"></div>
															</div>
														</div>
													</div>
												</div>
