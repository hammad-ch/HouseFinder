						...
						<div class="container">
							...
							<nav id="pageNav" class="navbar navbar-default pageNav1">
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<div class="navigation-wrapper">
										...
										<ul class="nav navbar-nav pageMainNav pageMainNav1">
											...
											<li>
												<a href="testimonials.com">Testimonials<span></span></a>
												<!-- <div class="frame-wrap">
													<div class="frame">
														<ul class="dropdown-menu pageMainNavDropdown pageMainNavDropdown1">
								...
								<div class="userOptions">
									...
									<!-- headerModalOpener -->
									<a href="add-house-01.html" class="headerModalOpener text-uppercase fontNeuron fwBold"><i class="openerIcon"></i> Submit Property</a>
								</div>
							</nav>
						</div>
					</div>
					...
					<section id="content" class="container pabIndent">
						...
						<header class="contentFiltersHeadingWrap row">
							<div class="col-xs-12 col-sm-10">
								...
								<h1 class="fontNeuron">Frequently Asked Questions</h1>
							</div>
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							  <div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingOne">
								  <h4 class="panel-title fontNeuron">
									<a role="button" class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									 Can a home depreciate in value?<i class="fi flaticon-arrows"></i>
									</a>
								  </h4>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingTwo">
								  <h4 class="panel-title fontNeuron">
									<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
									  Is an older home as good a value as a new home? <i class="fi flaticon-arrows"></i>
									</a>
								  </h4>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingThree">
								  <h4 class="panel-title fontNeuron">
									<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
									 What is a broker?<i class="fi flaticon-arrows"></i>
									</a>
								  </h4>
								</div>
								<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
								  <div class="panel-body">
									  <p>Ut euismod ultricies sollicitudin. Curabitur sed dapibus nulla. Nulla eget iaculis lectus. Mauris ac maximus neque. Nam in mauris quis libero sodales eleifend. Morbi varius, nulla sit amet rutrum elementum, est elit <a href="#">finibus</a> tellus, ut tristique elit risus at metus. Sed fermentum, lorem vitae efficitur imperdiet, neque velit tristique turpis, et iaculis mi tortor finibus turpis.</p>
									  <h6>Donec luctus lacinia sem potenti aptent est</h6>
									  <p>platea, orci tortor dui fringilla curae varius tempor, rhoncus commodo sapien auctor himenaeos laoreet maecenas tempor venenatis accumsan lacinia congue dolor laoreet, ut nostra nulla nunc aptent dolor quisque, lorem sociosqu nunc convallis curabitur faucibus.</p>
									  Ornare sagittis ante erat nec ultricies amet aenean netus sodales at, amet vehicula quis vel platea mattis vel felis hendrerit ad, at rhoncus tortor habitasse venenatis etiam senectus erat sit varius proin ligula lectus mi accumsan curabitur orci varius justo nec elit.
								  </div>
								</div>
							  </div>
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingFour">
								  <h4 class="panel-title fontNeuron">
									<a class="" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
									 What is the difference between being prequalified and preapproved for a loan?<i class="fi flaticon-arrows"></i>
									</a>
								  </h4>
								</div>
							...
							<div class="col-xs-12 col-sm-4 col">
								...
								<address>
									<dl>
										...
										<dd><a href="#">info@ousefinder.com</a></dd>
									</dl>
								</address>
							</div>
							<!-- ftNav -->
