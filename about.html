							...
							<div class="headerHolder">
								<div class="row">
									<div class="col-xs-6 col-sm-3">
										<!-- logo -->
										<div class="logo"><a href="home.html"><img src="images/houseFinderLogo.png" alt="HouseFinder"></a></div>
									</div>
									<div class="col-xs-6 col-sm-9 d-flex">
										...
										<ul class="list-unstyled headerContactList">
											...
											<li class="hidden-xs">
												...
												<div class="descr">
													<strong class="fwNormal elemenBlock text">Riphah International University I-14 <br>Golra Mor Islamabad</strong>
												</div>
											</li>
										</ul>
										<!-- headerSearchForm -->
				...
				<main>
					...
					<section class="propertyIntroBlock style2">
						...
						<div class="slick-fade slickSlider introSlider propertyIntroImageSlider">
							<div>
								<span class="bgCover elemenBlock introSlide" style="background-image: url(https://via.placeholder.com/1920x260);"></span>
							</div>
						</div>
						...
						<div class="container">
							<div class="row">
									...
									<div class="slickSlider testimonial-carousel testimonialSlider">
										<div>
											...
											<div class="testimonialColumn text-center">
												<img src="https://via.placeholder.com/460x340" alt="image description" class="img-responsive">
											</div>
										</div>
										<div>
											<!-- testimonialColumn -->
								...
								<div class="col-xs-12 col-sm-8 col-md-7">
									<h3 class="fontNeuron fwBold text-capitalize">We HouseFinder Real Estate.</h3>
									<p>If a person wants to get a house on rent he has to go through property dealers or any available online resources but still he is at a loss because at the end he doesn't meets his requirements as because of wrong information about the house given by the dealer or that area doesn't have a public parking lot, or he has trouble going to his office as the streets are too rushy. Now because of any problem faced by the person he isn't fully satisfied with his new home. If his new home doesn't have a garage he has to find a public garage, for which he has to ask people of that area and still he can't rely on people because he doesn't really know them, this information could be misleading.</p>
									<p>us.</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-4 col">
								<h2 class="fontNeuron fwSemi text-uppercase">HouseFinder</h2>
								<p>FYP Project</p>
								<address>
									<dl>
